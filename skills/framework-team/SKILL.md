...
**与 dev-team 的核心区别**：dev-team 围绕"现有代码"设计（plan-preview 探索代码库），本 skill 面向"从零开始"场景——无代码可探索，从需求出发设计架构、生成脚手架，再进入标准开发流程。
...
### 阶段 1: 架构设计（替代 dev-team 的 plan-preview）

**这是与 dev-team 唯一的本质区别。** 无代码可探索，从需求出发设计架构并生成 task.md。
